...
//mongodb+srv:// ...
const MONGO_URI = process.env.MONGO_URI || false;
if (!MONGO_URI) console.error("--- missing MONGO_URI in .env ---")
...
const API_RATE_LIMIT = parseInt(process.env.API_RATE_LIMIT) || 7; //requests per ip adress per 10 seconds
